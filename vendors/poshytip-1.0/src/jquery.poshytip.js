...
(function($) {
    ...
    $.Poshytip.prototype = {
        init: function() {
            ...
            if (typeof this.$elm.attr('title') !== 'undefined') {
        ...
        show: function() {
            if (!this.opts.onShow(this.$elm)) { return; }
        ...
        hide: function() {
            if (!this.opts.onHide(this.$elm)) { return; }
    ...
    $.fn.poshytip = function(options){
        ...
        if (!$('#poshytip-css-' + opts.className)[0])
            $(['<style id="poshytip-css-',opts.className,'" type="text/css">',
                'div.',opts.className,'{visibility:hidden;position:absolute;top:0;left:0;z-index:25000; pointer-events: none;}',
