...
<head>
    ...
    <script type="text/javascript" src="<?php echo $vars['url']; ?>mod/content_debugger/js/jquery/jquery.js"></script>
...
?>
    <script type="text/javascript" src="<?php echo $vars['url']; ?>/mod/trivantis_theme/js/fancybox/jquery.mousewheel-3.0.4.pack.js"></script>
    <script type="text/javascript" src="<?php echo $vars['url']; ?>/mod/trivantis_theme/js/fancybox/jquery.fancybox-1.3.4.pack.js"></script>
    <link rel="stylesheet" type="text/css" href="<?php echo $vars['url']; ?>/mod/trivantis_theme/js/fancybox/jquery.fancybox-1.3.4.css" media="screen" />
